...
<body>
    <div class="form-container">
        ...
        <form action="{{route ('ldrrmo.store')}}" method="POST" id="guest-form">
            @csrf
    ...
    <div class="input-group">
        ...
        <input type="text" name="agency_name" class="form-control" placeholder="Agency/ Office" required>
    </div>
</div>
...
<div class="mb-3">
    <div class="input-group">
        ...
        <input type="text" name="head_name" class="form-control" placeholder="Regional Director/ OIC / Focal Person" required>
    </div>
</div>
...
<div class="mb-3">
    <div class="input-group">
        <span class="input-group-text"><i class="bi bi-telephone-fill"></i></span>
        <input type="text" name="alt_contact_number" class="form-control" placeholder="Alternate Contact Number" required>
    </div>
</div>
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="official_email_add" class="form-control" placeholder="Official Email/Gmail" required>
                </div>
            </div>
            ...
            <div class="mb-3">
                <div class="input-group">
                    <span class="input-group-text"><i class="bi bi-geo-alt-fill"></i></span>
                    <input type="text" name="alt_email_add" class="form-control" placeholder="Alternate Email/Gmail" required>
                </div>
            </div>
